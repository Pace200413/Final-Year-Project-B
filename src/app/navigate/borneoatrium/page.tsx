...
export default function BorneoAtrium360Page() {
  /* pano / viewer state */
  ...
  const DEFAULT_PANO = '/images360/L-B-18.jpg';
  ...
  return (
    <>
      <Head>
        <title>Borneo Atrium • 360° Route</title>
      </Head>
      ...
      <SubpageLayout icon="" title="" description="">
        <div className="col-span-full">
          ...
          <header className="flex items-center gap-3 p-3 mb-4 bg-white border-2 border-red-700 rounded-2xl shadow-md shadow-red-200">
            ...
            <div>
              <h1 className="text-lg font-extrabold text-slate-900">Borneo Atrium</h1>
